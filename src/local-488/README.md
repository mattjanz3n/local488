...
$ git clone https://gitlab.local_488.se/dmitriy.olhovsky/local_488-starter.git
$ rename local_488-theme folder (better with underscores or together like in 'twentyseventeen')
$ cd your_theme_name
```
...
```bash
$ in the beginning of functions.php find Text domain definition and replace 'local_488' with the text domain according to your theme name
$ find & replace 'local_488_' and 'local_488' in the whole theme with your theme name
