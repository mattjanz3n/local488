( function ( $ ) {
	function changeImages() {
		$( '.acf-tooltip ul li a' ).hover(
			function () {
				const imageLayoutSlug = $( this ).attr( 'data-layout' );
				if (
					typeof flexibleContentThumbs.files[ imageLayoutSlug ] !==
					'undefined'
				) {
					$( '.acf-tooltip' ).append(
						'<div class="module-preview"><img src="' +
							flexibleContentThumbs.files[ imageLayoutSlug ] +
							'"></div>'
					);
				}
			},
