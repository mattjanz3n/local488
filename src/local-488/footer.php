...
<footer id="footer-container" class="footer" role="contentinfo"
	<?php if ( ! empty( $fields['footer_bg'] ) ) : ?>
		style="background-color: <?php echo $fields['footer_bg']; ?>"
	<?php endif; ?>>
	<div class="container container-relative">
		<?php if ( ! empty( $option_fields['large_tagline_text'] ) ) : ?>
			<div class="footer__large-text">
				<?php echo $option_fields['large_tagline_text']; ?>
			</div>
		<?php endif; ?>
	</div>
			...
			<div class="footer__main">
				<div class="footer__column">
					<?php if ( ! empty( $option_fields['column_1_title'] ) ) : ?>
						<h6 class="footer__title white">
							<?php echo $option_fields['column_1_title']; ?>
						</h6>
					<?php endif; ?>
					<?php if ( ! empty( $option_fields['column_1_image'] ) ) : ?>
					<div class="footer__logo">
						<img src="<?php echo $option_fields['column_1_image']['url']; ?>" alt="<?php echo $option_fields['column_1_image']['title']; ?>">
						</h6>
						<?php endif; ?>
					</div>
					<?php if ( ! empty( $option_fields['copyright'] ) ) : ?>
						<div class="footer__copyright">
							<?php echo $option_fields['copyright']; ?>
						</div>
					<?php endif; ?>
				</div>
				<div class="footer__column">
					<?php if ( ! empty( $option_fields['column_2_title'] ) ) : ?>
						<h6 class="footer__title white">
							<?php echo $option_fields['column_2_title']; ?>
						</h6>
					<?php endif; ?>
				...
				<div class="footer__column">
					<?php if ( ! empty( $option_fields['column_3_title'] ) ) : ?>
						<h6 class="footer__title white">
							<?php echo $option_fields['column_3_title']; ?>
						</h6>
					<?php endif; ?>
					<?php if ( ! empty( $option_fields['links'] ) ) : ?>
						<div class="footer__links">
							<?php
							foreach ( $option_fields['links'] as $link ) :
								...
								?>
								<a target="<?php echo $link_target; ?>" href="<?php echo $link_url; ?>" class="button-secondary footer__button"><?php echo $link_title; ?></a>
							<?php endforeach; ?>
						</div>
					<?php endif; ?>
				</div>
