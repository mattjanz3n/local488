...
if ( ! class_exists( 'Local_488_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Local_488_Protocol_Relative_Theme_Assets class
	 */
	class Local_488_Protocol_Relative_Theme_Assets {
		/**
	...
	$local_488_protocol_relative_theme_assets = new Local_488_Protocol_Relative_Theme_Assets();
endif;
